...
function sendMailToMe() {
	...
	//Recipients
    $mail->setFrom('no-reply@arenagurgaon.com', 'New Enquiry - ArenaSohna');
    $mail->addAddress('arena.gurgaon2@gmail.com', 'Contact us - ArenaSohna');     // Add a recipient
...
try {
	...
	//Recipients
    $mail->setFrom('no-reply@arenagurgaon.com', 'ArenaSohna');
    $mail->addAddress($_POST['email'], $_POST['fullnm']);     // Add a recipient
    // $mail->addAddress('aayush.jaiswal984@gmail.com');               // Name is optional
    $mail->addReplyTo('arena.gurgaon2@gmail.com', 'Replay');
    // $mail->addCC('cc@example.com');
    // $mail->addBCC('bcc@example.com');
    ...
    $mail->Body    = '<h1>Arena Sohna Road</h1><p>This is a confirmation that we have recived your mail and we will contact to you ASAP.</p>';
	    // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
	    $mail->send();
        return true;
	} catch (Exception $e) {
